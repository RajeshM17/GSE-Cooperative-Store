...
class Show extends Component {
    ...
    formSubmitHandler=async(event)=>{
        ...
        const res=await axios.post(`/products/${this.props.match.params.id}/review`,{rating:this.state.rating,comment:this.state.comment})
        console.log(res);
        this.setState({
            rating:1,
            comment:''
                ...
                <Col lg={6} md={12}>
                    ...
                    <Form onSubmit={this.formSubmitHandler}>
                            <Form.Group className="mb-3">
                                ...
                                <br></br>
                                <Form.Control min="1" max="5" type="range" name="rating" value={this.state.rating} onChange={this.changeHandler}/>
                            </Form.Group>
